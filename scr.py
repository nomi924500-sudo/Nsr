...
FORCE_CHANNEL = -1003560840998  # channel ID

from pyrogram.errors import UserNotParticipant, ChatAdminRequired
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton
from pyrogram.enums import ParseMode

async def force_join_pvt(client, message):
    try:
        ...
        await message.reply(
            "🚫 <b>You haven't joined the required channel yet</b>\n\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                    InlineKeyboardButton(
                        "📢 Join Channel",
                        url="https://t.me/+B41iEYndAB9lZjY9"
                    )
                ]]
            )
        )
...
OWNER_ID = 7078867529          # Bot owner only
ADMINS_FILE = "admins.txt"     # Admin save file
...
ADMIN_IDS = load_admins() | {OWNER_ID}
...
user = Client(
    ...
    api_id=int(API_ID),
    api_hash=API_HASH,
    session_string=str(SESSION_STRING).strip().replace("\n", "").replace(" ", ""),
    workers=50
)
...
START_MESSAGE = """
<b>╔══════════════════════╗</b>
<b>   🕵️‍♂️ Credit Card Scraper Bot 💳   </b>
<b>╚══════════════════════╝</b>

<i>Welcome! This bot helps you collect data from Telegram channels easily.</i>

<b>📌 Available Commands</b>
━━━━━━━━━━━━━━━━━━
🔹 <b>/scr</b> <code>[channel]</code> <code>[limit]</code>  
  Scrape from a single channel 📺

🔹 <b>/mc</b> <code>[channel1 channel2 ...]</code> <code>[limit]</code>  
  Scrape from multiple channels 📡

<b>🧪 Usage Examples</b>
━━━━━━━━━━━━━━━━━━
<code>/scr @username 100</code>  
<code>/scr @username 100 515462</code>  
<code>/scr @username 100 BankName</code>  

<code>/scr t.me/username 100</code>  
<code>/scr https://t.me/username 100</code>  

<code>/scr https://t.me/+kP5r_KyYEGUyZmM1 100</code>  
<code>/scr https://t.me/+kP5r_KyYEGUyZmM1 100 BankName</code>  

<b>👥 Member Limits</b>
━━━━━━━━━━━━━━━━━━
🆓 <b>FREE MEMBER</b> : <code>3000</code>  
💎 <b>PREMIUM MEMBER</b> : <code>50000</code>

<b>⚠️ Notes</b>
━━━━━━━━━━━━━━━━━━
• Use valid public channels  
• Higher limits for admins & premium users  
...
async def add_admin(client, message):
    if not message.reply_to_message:
        return await message.reply(
            "❌ Please reply to a user and use `/addadmin`"
        )
...
def get_user_limit(user_id: int):
    return ADMIN_LIMIT if user_id in ADMIN_IDS else DEFAULT_LIMIT
...
async def get_user_link(message):
    if message.from_user is None:
        return '<a href="https://t.me/+kP5r_KyYEGUyZmM1">JOIN</a>'
    else:
...
def setup_scr_handler(app):
    ...
    async def scr_cmd(client, message):
        ...
        temporary_msg = await client.send_message(
    message.chat.id,
    ...
    "▰▰▱▱▱▱▱▱▱▱"
        ...
        # Start scraping
        await temporary_msg.edit_text(
    "<b>🔄 Scraping In Progress</b>\n"
    "▰▰▰▱▱▱▱▱▱\n"
    "<i>Do not close the bot</i>"
)
...
async def start(client, message):
    ...
    if not await force_join_pvt(client, message):
        return
